...
subroutine run_extract_c
  ...
  integer(bit_kind) :: res1(N_int,2), res2(N_int,2), res3(N_int,2), res4(N_int,2), res5(N_int,2), exc(0:2,2,2)
  integer(bit_kind), allocatable :: tmp_det(:,:,:), l_det(:,:,:)
  logical :: ok, extract_c3, extract_c4
