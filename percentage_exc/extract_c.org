...
subroutine smart_xc(nO,nV,t1_full,t2_full)
  ...
  !          t2_idx(2,i) == t2_idx(2,j) .or. &
  !          t2_idx(3,i) == t2_idx(3,j) .or. t2_idx(3,i) == t2_idx(4,j) .or. &
  !          t2_idx(4,i) == t2_idx(4,j)) cycle
  !      idx = idx + 1
  !    endif
  !  enddo
  !enddo
  ...
  !sze_t111 = idx
  !allocate(t111(size_t111),t111_idx(6,sze_t111))
  !      
  !idx = 1
  !do i = 1, sze_t1
  !  do j = 1, sze_t11
  ...
  integer(bit_kind), allocatable :: psi_det_t11(:,:,:)
  double precision, allocatable :: psi_coef_t11(:)
  allocate(psi_det_t11(1,2,sze_t11),psi_coef_t11(sze_t11))

  ! Build the det
  call build_det_t(t11,t11_idx,sze_t11,4,psi_det_t11,psi_coef_t11)

  ! Sort
  call sort_det(psi_det_t11,psi_coef_t11,sze_t11)
  !print*,''
  !do i = 1, sze_t11
  !  print*,'c',psi_coef_t11(i),psi_det_t11(1,1,i),psi_det_t11(1,2,i)
  !  !call print_det(psi_det_t11(1,1,i),N_int)
  !enddo

  integer :: new_sze_t11
  ! Sum contributions from duplicates and remove them
  call remove_duplicate(psi_det_t11,psi_coef_t11,sze_t11,new_sze_t11)
  print*,''
  do i = 1, new_sze_t11
    print*,'c',psi_coef_t11(i),psi_det_t11(1,1,i),psi_det_t11(1,2,i)
  enddo
  !print*,sze_t11,new_sze_t11
...
** Remove duplicate
#+begin_src f90 :comments org :tangle exp_c.irp.f
subroutine remove_duplicate(psi_det_t,psi_coef_t,sze_t,new_sze_t)
