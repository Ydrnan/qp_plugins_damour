...
subroutine smart_xc(nO,nV,t1_full,t2_full)
  ...
  call recursive_sort(t11,t11_idx,sze_t11,4,1)
  call recursive_sort(t12,t12_idx,sze_t12,6,1)
  call recursive_sort(t22,t22_idx,sze_t22,8,1)

  call recursive_sort(t111,t111_idx,sze_t111,6,1)
  call recursive_sort(t112,t112_idx,sze_t112,8,1)
  
  call recursive_sort(t1111,t1111_idx,sze_t1111,8,1)
  ...
  ! Sort
  call recursive_sort(c2,c2_idx,sze_c2,4,1)
  call recursive_sort(c3,c3_idx,sze_c3,6,1)
  call recursive_sort(c4,c4_idx,sze_c4,8,1)
  ...
  do i = 2, sze_cc
    ...
    !print*,phase
    !call get_phase(det,psi_det(1,1,i),phase,N_int)
    !print*,phase
  ...
  print*,'energy',energy+nuclear_repulsion
...
#+begin_src f90 :comments org :tangle exp_c.irp.f
recursive subroutine recursive_sort(t,t_idx,sze,n_idx,idx)
  ...
  if (idx < n_idx) then
    ...
    call search_unique(t,t_idx,sze,n_idx,idx,nb_u,nu,pu)

    do i = 1, nb_u
      call recursive_sort(t(pu(i)),t_idx(1,pu(i)),nu(i),n_idx,idx+1)
    enddo
    deallocate(pu,nu)
...
*** Unique
#+begin_src f90 :comments org :tangle exp_c.irp.f
subroutine search_unique(t,t_idx,sze,n_idx,idx,nb_u,nu,pu)
