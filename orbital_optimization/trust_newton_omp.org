...
#+BEGIN_SRC f90 :comments org :tangle org_trust_newton.irp.f
  ...
  ! Initialization  
  i = 1
  f_N = f_norm_trust_region_omp(n,e_val,w,v_grad,lambda) ! Value of the ||x(lambda)||^2
  ...
  if (version == 1) then
    ...
    d_1 = d1_norm_trust_region_omp(n,e_val,w,v_grad,lambda,delta) ! first derivative of (||x(lambda)||^2 - delta^2)^2
    d_2 = d2_norm_trust_region_omp(n,e_val,w,v_grad,lambda,delta) ! second derivative of (||x(lambda)||^2 - delta^2)^2
    ...
    do while (i <= 100 .and. ABS(1d0-f_N/delta**2) > thresh_cc) !1d-6)
      ...
      d_1 = d1_norm_trust_region_omp(n,e_val,w,v_grad,lambda,delta)
      d_2 = d2_norm_trust_region_omp(n,e_val,w,v_grad,lambda,delta)
      ...
      if (lambda > MAX(0d0, -e_val(1))) then !-e_val(1)) then ! MAX(0d0, -e_val(1)) if e_val = ABS(e_val)....
        f_N = f_norm_trust_region_omp(n,e_val,w,v_grad,lambda) ! new value of ||x(lambda)||^2
    ...
    d_1 = d1_norm_inverse_trust_region_omp(n,e_val,w,v_grad,lambda,delta) ! first derivative of (1/||x(lambda)||^2 - 1/delta^2)^2
    d_2 = d2_norm_inverse_trust_region_omp(n,e_val,w,v_grad,lambda,delta) ! second derivative of (1/||x(lambda)||^2 - 1/delta^2)^2
    ...
    do while (i <= 100 .and. ABS(1d0-f_N/delta**2) > thresh_cc) !1d-6)
      ...
      d_1 = d1_norm_inverse_trust_region_omp(n,e_val,w,v_grad,lambda,delta)
      d_2 = d2_norm_inverse_trust_region_omp(n,e_val,w,v_grad,lambda,delta)
      write(*,'(a,E12.5,a,E12.5)') ' 1st and 2nd derivative: ', d_1,', ', d_2     
...
#+BEGIN_SRC f90 :comments org :tangle org_trust_newton.irp.f
function d1_norm_inverse_trust_region_omp(n,e_val,w,v_grad,lambda,delta)
...
#+BEGIN_SRC f90 :comments org :tangle org_trust_newton.irp.f
function d2_norm_inverse_trust_region_omp(n,e_val,w,v_grad,lambda,delta)
