...
subroutine algo_trust_cartesian_template(tmp_n)
  ...
  PROVIDE df2_mc df_mc f_mc x_position cc_mc
  print*,'H',df2_mc
  print*,'g',df_mc
  print*,'pos',x_position

  call random_number(x_position)
  x_position(1) = x_position(1) * 5.5d0 - 1.5d0
  x_position(2) = x_position(2) * 7d0 - 3d0
  TOUCH x_position

  print*,'H',df2_mc
  print*,'g',df_mc
  print*,'pos',x_position
  write(*,'(A,3E15.5)') 'new pos:',x_position, f_mc
  ...
  do while (not_converged)
      ...
      if (nb_iter > 0) then
        PROVIDE df2_mc df_mc
      endif

      ! Diagonalization of the hessian 
      call diagonalization_hessian(tmp_n,df2_mc,e_val,W)
      ...
      do while (cancel_step)
          ...
          call trust_region_step_w_expected_e(tmp_n,df2_mc, W, e_val,df_mc, &
          ...
          if (cancel_step) then
              ...
              TOUCH x_position df2_mc df_mc f_mc cc_mc
          endif      
      ...
      ! To exit
      if (dabs(cc_mc) < thresh_opt_max_elem_grad) then
        not_converged = .False.
      endif
      ...
      print*,cc_mc
      print*,(dabs(cc_mc) < thresh_opt_max_elem_grad)
