subroutine diag_hess(n,H, h_tmpr)
  ...
  istate = 1
    ...
    ! =
    ! 0.5d0 * (  &
    !  get_two_e_integral(u,v,p,t,mo_integrals_map) * two_e_dm_mo(u,v,q,t,istate) &
    !+ get_two_e_integral(q,t,u,v,mo_integrals_map) * two_e_dm_mo(p,t,u,v,istate))
    ! = 
    ! get_two_e_integral(u,v,p,t,mo_integrals_map) * two_e_dm_mo(u,v,q,t,istate)
  ...
  ! =
  ! 0.5d0 * (  &
  !  get_two_e_integral(u,v,p,t,mo_integrals_map) * two_e_dm_mo(u,v,p,t,istate) &
  !+ get_two_e_integral(p,t,u,v,mo_integrals_map) * two_e_dm_mo(p,t,u,v,istate))
  ! = 
  ! get_two_e_integral(u,v,p,t,mo_integrals_map) * two_e_dm_mo(u,v,p,t,istate)
 ...
 !!!!! Second line, second term
  ...
  ! get_two_e_integral(p,t,u,v,mo_integrals_map) * two_e_dm_mo(p,t,u,v,istate)
    ...
    ! = 
    ! 0.5d0 * ( &
    !  get_two_e_integral(p,t,u,v,mo_integrals_map) * two_e_dm_mo(q,t,u,v,istate) &
    !+ get_two_e_integral(u,v,q,t,mo_integrals_map) * two_e_dm_mo(u,v,p,t,istate))
    ! =
    ! get_two_e_integral(q,t,u,v,mo_integrals_map) * two_e_dm_mo(q,t,u,v,istate)
      ...
      do q = 1, mo_num
        do v = 1, mo_num
          do u = 1, mo_num
             ...
             tmp_2rdm_3(u,v,q) = two_e_dm_mo(u,v,q,t,istate)
    ...
    !+ get_two_e_integral(q,s,u,v,mo_integrals_map) * two_e_dm_mo(p,r,u,v,istate) 
    ! = 
    !  get_two_e_integral(u,v,p,p,mo_integrals_map) * two_e_dm_mo(u,v,q,q,istate) &
    !+ get_two_e_integral(q,q,u,v,mo_integrals_map) * two_e_dm_mo(p,p,u,v,istate)
    ! = 
    ! 2d0 * get_two_e_integral(u,v,p,p,mo_integrals_map) * two_e_dm_mo(u,v,q,q,istate)
    ...
    do q = 1, mo_num
      do v = 1, mo_num
        do u = 1, mo_num
          ...
          tmp_2rdm_3(u,v,q) = two_e_dm_mo(u,v,q,q,istate)
    ...
    !+ get_two_e_integral(q,s,u,v,mo_integrals_map) * two_e_dm_mo(p,r,u,v,istate) 
    ! = 
    !  get_two_e_integral(u,v,p,q,mo_integrals_map) * two_e_dm_mo(u,v,q,p,istate) &
    !+ get_two_e_integral(q,p,u,v,mo_integrals_map) * two_e_dm_mo(p,q,u,v,istate)
    ! = 
    ! 2d0 * get_two_e_integral(u,v,p,q,mo_integrals_map) * two_e_dm_mo(u,v,q,p,istate)
      ...
      do p = 1, mo_num
        do v = 1, mo_num
          do u = 1, mo_num
            ...
            tmp_2rdm_3(u,v,p) = two_e_dm_mo(u,v,p,q,istate)
    ...
    ! - get_two_e_integral(q,u,t,r,mo_integrals_map) * two_e_dm_mo(p,u,t,s,istate)
    ! =
    ! - get_two_e_integral(q,t,p,u,mo_integrals_map) * two_e_dm_mo(p,t,q,u,istate) &
    ! - get_two_e_integral(t,q,p,u,mo_integrals_map) * two_e_dm_mo(t,p,q,u,istate) &
    ! - get_two_e_integral(q,u,p,t,mo_integrals_map) * two_e_dm_mo(p,u,q,t,istate) &
    ! - get_two_e_integral(q,u,t,p,mo_integrals_map) * two_e_dm_mo(p,u,t,q,istate)
    ! =
    ! - 2d0 * get_two_e_integral(q,t,p,u,mo_integrals_map) * two_e_dm_mo(p,t,q,u,istate) &
    ! - 2d0 * get_two_e_integral(t,q,p,u,mo_integrals_map) * two_e_dm_mo(t,p,q,u,istate) 
      ...
      do p = 1, mo_num
        do u = 1, mo_num
          do q = 1, mo_num
             ...
             tmp_2rdm_3(q,u,p) = two_e_dm_mo(q,u,p,t,istate)
   ...
   ! part 2 of the term
      ...
      do p= 1, mo_num
        do q = 1, mo_num
           do t = 1, mo_num
              ...
              tmp_2rdm_3(t,q,p) = two_e_dm_mo(t,p,q,u,istate)
    ...
    ! - get_two_e_integral(q,u,t,r,mo_integrals_map) * two_e_dm_mo(p,u,t,s,istate)
    ! =
    ! - get_two_e_integral(p,t,p,u,mo_integrals_map) * two_e_dm_mo(q,t,q,u,istate) &
    ! - get_two_e_integral(t,p,p,u,mo_integrals_map) * two_e_dm_mo(t,q,q,u,istate) &
    ! - get_two_e_integral(q,u,q,t,mo_integrals_map) * two_e_dm_mo(p,u,p,t,istate) &
    ! - get_two_e_integral(q,u,t,q,mo_integrals_map) * two_e_dm_mo(p,u,t,p,istate)

!!     do q = 1, mo_num
!!       do u = 1, mo_num
!!         do t = 1, mo_num
!!     
!!           tmp_2rdm_3(t,u,q) = two_e_dm_mo(t,q,u,q,istate)
!!
!!         enddo
!!       enddo
!!     enddo
...
!!        do u = 1, mo_num
!!
!!          tmp_2rdm_3(u,t,q) = two_e_dm_mo(q,u,t,q,istate)
!!
!!        enddo
!!      enddo 
!!    enddo
