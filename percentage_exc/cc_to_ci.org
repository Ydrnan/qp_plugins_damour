...
subroutine smart_xc(nO,nV,t1_full,t2_full)
  ...
  integer :: sze_t2_f,sze_t22_f
  double precision, allocatable :: t2_f(:),t22_f(:)
  integer, allocatable :: t2_idx_f(:,:),t22_idx_f(:,:)
