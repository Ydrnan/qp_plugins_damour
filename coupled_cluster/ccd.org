...
!  print*, 'epsilon:', epsilon
  ...
  do while (not_converged)
    ...
    if (dnrm2(n_occ*n_occ*n_vir*n_vir,r,1) < thresh_conv ) then
     ! nb_parameters = 0
     ! k = 1
     ! do b = 1, n_vir
     !   tmp_b = n_occ + b
     ...
     !     do j = 1, n_occ
     !       do i = 1, n_occ
     !          sorted_t2(k) = -dabs(t2(i,j,a,b)*two_e_int_spin_orb(i,j,tmp_a,tmp_b))
    ...
    do a = 1, n_vir
      ...
      do j = 1, n_occ
        do i = 1, n_occ
          ...
          if (dabs(two_e_int_spin_orb(i,j,tmp_a,tmp_b)) /delta(i,j,a,b) >= epsilon) then
        ...
        do j = 1, n_occ
          do i = 1, n_occ
            ...
            if (dabs(two_e_int_spin_orb(i,j,tmp_a,tmp_b)) /delta(i,j,a,b) >= epsilon) then
              ...
              !  (two_e_int_spin_orb(i,j,tmp_a,tmp_b,mo_integrals_map) + u(i,j,a,b) + v(i,j,a,b))
            else
              t2(i,j,a,b) = 0d0
            endif 
