...
&BEGIN_PROVIDER [double precision, multi_s_z_deriv_1, (N_states, N_states)]
  ...
  do jstate = 1, N_states
    do istate = 1, N_states
      ...
      do i = 1, mo_num  
        ! Diag part
        multi_s_x_deriv_1(istate,jstate) -= multi_s_dm(i,i,istate,jstate) * mo_deriv_1_x(i,i)
        multi_s_y_deriv_1(istate,jstate) -= multi_s_dm(i,i,istate,jstate) * mo_deriv_1_y(i,i)
        multi_s_z_deriv_1(istate,jstate) -= multi_s_dm(i,i,istate,jstate) * mo_deriv_1_z(i,i)
        ...
        do j = 1, mo_num  
          ...
          ! Extra diag part
          multi_s_x_deriv_1(istate,jstate) -= multi_s_dm(j,i,istate,jstate) * mo_deriv_1_x(j,i)  
          multi_s_y_deriv_1(istate,jstate) -= multi_s_dm(j,i,istate,jstate) * mo_deriv_1_y(j,i) 
          multi_s_z_deriv_1(istate,jstate) -= multi_s_dm(j,i,istate,jstate) * mo_deriv_1_z(j,i) 
        enddo
      enddo
