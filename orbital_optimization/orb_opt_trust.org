...
!!#      call step_in_trust_region(n,mo_num,H,v_grad,prev_criterion,rho,nb_iter,delta,criterion_model,x,must_exit) 
!!#      if (must_exit) then
!!#        ! ### Message ###
...
!!#      call is_step_cancel_trust_region(nb_iter,prev_criterion, criterion, criterion_model,thresh_rho,rho,cancel_step)
!!#
!!#      ! ### TODO ###
!!#      !if (cancel_step) then
