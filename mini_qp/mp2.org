...
subroutine cipsi_mp2
  ...
  allocate(dressing(N_det), d_energies(N_states_diag))
  ...
  !$OMP PARALLEL &
  !$OMP SHARED(psi_det,v_aaaa,v_abab,v_abba,dressing,N_det) &
  !$OMP PRIVATE(j,E2_v2) &
  !$OMP DEFAULT(NONE) 
  !$OMP DO
  do j = 1, N_det
  ...
  call dav_dressed(dressing,N_det,d_energies,N_states_diag,N_states)
