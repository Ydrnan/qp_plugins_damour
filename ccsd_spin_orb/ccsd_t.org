...
subroutine compute_par_t_v2(nO,nV,t1,t2,f_o,f_v,f_ov,v_ooov,v_vvoo,v_vvvo,energy)
  ...
  !$OMP SHARED(A_ovvv,ta,tb,t3_bc,s,e_t,e_st,e_dt,t2,v_vvvo,v_ooov, &
  !$OMP         v_vvoo,f_o,f_v,f_ov,delta,delta_abc,nO,nV) &
  !$OMP DEFAULT(NONE)
            ...
            do j = 1, nO
              do i = 1, nO
               t3_bc(i,j,k,a) = t3_bc(i,j,k,a) &
                   + t2(j,k,a,e) * A_ovvv(i,e,b,c) &!v_vvvo(b,c,e,i) &
                   - t2(i,k,a,e) * A_ovvv(j,e,b,c) &!v_vvvo(b,c,e,j) & ! - P(ij)
                   - t2(j,i,a,e) * A_ovvv(k,e,b,c) &!v_vvvo(b,c,e,k) & ! - P(ik)
                   - t2(j,k,b,e) * A_ovvv(i,e,a,c) &!v_vvvo(a,c,e,i) & ! - P(ab)
                   - t2(j,k,c,e) * A_ovvv(i,e,b,a) &!v_vvvo(b,a,e,i) & ! - P(ac)
                   + t2(i,k,b,e) * A_ovvv(j,e,a,c) &!v_vvvo(a,c,e,j) & ! + P(ij) P(ab)
                   + t2(i,k,c,e) * A_ovvv(j,e,b,a) &!v_vvvo(b,a,e,j) & ! + P(ij) P(ac)
                   + t2(j,i,b,e) * A_ovvv(k,e,a,c) &!v_vvvo(a,c,e,k) & ! + P(ik) P(ab)
                   + t2(j,i,c,e) * A_ovvv(k,e,b,a)  !v_vvvo(b,a,e,k)   ! + P(ik) P(ac)
              enddo
            enddo
          enddo
        enddo
