...
subroutine smart_xc(nO,nV,t1_full,t2_full)
  ...
  integer :: sze_t2_f,sze_t11_f,sze_t22_f
  double precision, allocatable :: t2_f(:),t11_f(:),t22_f(:)
  integer, allocatable :: t2_idx_f(:,:),t11_idx_f(:,:),t22_idx_f(:,:)

  ! T2
  print*,'T2'
  call contrib_t2_full_nb(nO,nV,thresh,1d-16,t2_full,sze_t2_f)
  print*,sze_t2_f
  allocate(t2_f(sze_t2_f),t2_idx_f(4,sze_t2_f))
  call contrib_t2_full(nO,nV,thresh,1d-16,t2_full,sze_t2_f,t2_f,t2_idx_f)

  ! T11
  print*,'T11'
  call contrib_t11_full_nb(nO,nV,thresh,1d-16,sze_t1,t1,t1_idx,sze_t11_f)
  print*,sze_t11_f
  allocate(t11_f(sze_t11_f),t11_idx_f(4,sze_t11_f))
  call contrib_t11_full(nO,nV,thresh,1d-16,sze_t1,t1,t1_idx,sze_t11_f,t11_f,t11_idx_f)
  ...
  ! C2
  double precision, allocatable :: tmp_c2(:)
  integer, allocatable :: tmp_c2_idx(:,:)
...
** T2 fill square
#+begin_src f90 :comments org :tangle cc_to_ci.irp.f
subroutine contrib_t2_full_nb(nO,nV,thresh1,thresh2,t2_full,sze_t2)

  implicit none

  ! in
  integer, intent(in)             :: nO,nV
  double precision, intent(in)    :: thresh1, thresh2, t2_full(nO,nO,nV,nV)
...
subroutine contrib_t2_full(nO,nV,thresh1,thresh2,t2_full,sze_t2,t2,t2_idx)
