...
subroutine algo_trust_cartesian_template(tmp_n)
  ...
  PROVIDE df2_gp df_gp f_gp x_position cc_gp
  print*,'H',df2_gp
  print*,'g',df_gp
  ...
  do while (not_converged)
      ...
      if (nb_iter > 0) then
        PROVIDE df2_gp df_gp
      endif

      ! Diagonalization of the hessian 
      call diagonalization_hessian(tmp_n,df2_gp,e_val,W)
      ...
      do while (cancel_step)
          ...
          call trust_region_step_w_expected_e(tmp_n,df2_gp, W, e_val,df_gp, &
          ...
          if (cancel_step) then
              ...
              TOUCH x_position df2_gp df_gp f_gp cc_gp
          endif      
      ...
      ! To exit
      if (dabs(cc_gp) < thresh_opt_max_elem_grad) then
        not_converged = .False.
      endif
      ...
      print*,cc_gp
      print*,(dabs(cc_gp) < thresh_opt_max_elem_grad)
