...
#+BEGIN_SRC f90 :comments org :tangle trust_region.irp.f 
#+END_SRC
...
#+BEGIN_SRC f90 :comments org :tangle trust_region.irp.f
subroutine trust_region(n,m,nb_iter,v_grad,rho,e_val,w,x,m_x,delta)
...
#+BEGIN_SRC f90 :comments org :tangle trust_region.irp.f
  ...
  if (e_val(1) > - thresh_eig) then
    ...
    ! H positive definite, ||x(lambda = 0)|| > Delta
      ...
      call trust_newton_omp(n,e_val,tmp_wtg,delta,lambda)
    endif
