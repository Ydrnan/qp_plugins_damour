...
subroutine run_fcc()
  ...
  double precision :: H, r, energy, max_r, phase
...
do i = 1, 100
  ...
  do tb = 1, nT_b
    ...
    do ta = 1, nT_a
      ...
      call get_phase(det_bit_ab(1,1,1),det_bit_ab(1,da,db),phase,N_int)
