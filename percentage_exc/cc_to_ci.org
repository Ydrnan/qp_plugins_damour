...
subroutine smart_xc(nO,nV,t1_cc,t2_cc)
  ...
  integer :: sze_t3,sze_t33
  integer :: sze_t13, new_sze_t13
  double precision, allocatable :: t13(:),t33(:)
  integer, allocatable :: t13_idx(:,:),t33_idx(:,:)
  ...
  call contrib_t33_nb(nO,nV,thresh,sze_t3,t3,t3_idx,sze_t33,t33,t33_idx)
  ...
  integer, allocatable :: t222_idx_f(:,:),t3_idx_f(:,:)
