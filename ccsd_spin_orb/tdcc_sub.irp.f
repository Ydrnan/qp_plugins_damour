subroutine run_tdcc()
  ...
  do while (not_converged)
    ...
    M1 = 0d0
    M2 = 0d0
    print*,t1(ma,na),t1(nb,mb)
    !!call compute_M1_A(nO,nV,det,t1,t2,M1)
    !call ost1ia_opt(nO,nV,det,t1,t2,M1,M2)
    !!call ost_test_disc2(nO,nV,det,t1,t2,M1,M2)
    !!call ost1ia_test_disc(nO,nV,det,t1,t2,M1,M2)
!    call os_t1(nO,nV,det,t1,t2,M1)
!    !call ost1_test_disc(nO,nV,det,t1,t2,M1,M2)
!    call os_t_disc(nO,nV,det,t1,t2,M2)
!    call os_t2(nO,nV,det,t1,t2,M2)
    ...
    call os_t1_act(nO,nV,det,t1,t2,M1)
    call os_t_disc_act(nO,nV,det,t1,t2,M2)
    call os_t2_act(nO,nV,det,t1,t2,M2)
