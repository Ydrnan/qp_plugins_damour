...
program ccsd
  ...
  !! Init
  call guess_t1_space(nO,nV,t1)
  call guess_t2_space(nO,nV,t2) 
  ...
  do while (not_converged)
    ...
    if (cc_update_method == 'diis') then
      ...
      !do a = 1, nV
      !  do i = 1, nO
      !    err1(i,a) = - r1(i,a) / (fcc_v(a) - fcc_o(i)) 
      !  enddo
      !enddo
      ...
      call update_t1_space (nO,nV,r1,t1)
      ...
      do b = 1, nV
        do a = 1, nV
          do j = 1, nO
            do i = 1, nO
              err2(i,j,a,b) = - r2(i,j,a,b) / (fcc_v(a) + fcc_v(b) - fcc_o(i) - fcc_o(j))
            enddo
          enddo
        enddo
      enddo
    ...
    elseif (cc_update_method == 'none') then
      ...
      call update_t1_space (nO,nV,r1,t1)
      call update_t2_space (nO,nV,r2,t2)
