...
subroutine run_ccsd_spin_orb
  ...
  do while (not_converged)
    ...
    call update_t_ccsd_v2(nO,nV,nb_iter,f_o,f_v,r1,r2,t1,t2,all_err1,all_err2,all_t1,all_t2)
    ...
    write(*,'(A3,I6,A3,F18.12,A3,F16.12,A3,1pE10.2,A3,1pE10.2,A2)') ' | ',nb_iter,' | ', hf_energy+energy,' | ', energy,' | ', max_r1,' | ', max_r2,' |'
  ...
  print*,''
  write(*,'(A15,F18.12,A3)') ' E(CCSD)     = ', hf_energy+energy, ' Ha'
