    ...
    do a = 1, nV
      ...
      do j = 1, nO
        do i = 1, nO
          ...
          e_ccd = e_ccd + t2(i,j,a,b) * w_oovv(i,j,a,b)
        enddo
      enddo
    enddo
  enddo
...
subroutine space_ccd_G1(t2,g_occ,G1)
  ...
  double precision, intent(out) :: G1(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_G2(t2,g_occ,G2)
  ...
  double precision, intent(in)  :: t2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(in)  :: g_occ(dim_list_act_orb, dim_list_act_orb)
  double precision, intent(out) :: G2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_G3(t2,g_vir,G3)
  ...
  double precision, intent(out) :: G3(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_G4(t2,g_vir,G4)
  ...
  double precision, intent(in)  :: t2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(in)  :: g_vir(dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(out) :: G4(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_J1a(t2,J1,J1a)
  ...
  double precision, intent(out) :: J1a(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_J1b(t2,J1,J1b)
  ...
  double precision, intent(in)  :: t2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(in)  :: J1(dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb, dim_list_act_orb)
  double precision, intent(out) :: J1b(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_K1a(t2,K1,K1a)
  ...
  double precision, intent(out) :: K1a(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_K1b(t2,K1,K1b)
  ...
  double precision, intent(in)  :: t2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(in)  :: K1(dim_list_act_orb, dim_list_virt_orb, dim_list_act_orb, dim_list_virt_orb)
  double precision, intent(out) :: K1b(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_K1c(t2,K1,K1c)
  ...
  double precision, intent(in)  :: t2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(in)  :: K1(dim_list_act_orb, dim_list_virt_orb, dim_list_act_orb, dim_list_virt_orb)
  double precision, intent(out) :: K1c(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_K1d(t2,K1,K1d)
  ...
  double precision, intent(in)  :: t2(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
  double precision, intent(in)  :: K1(dim_list_act_orb, dim_list_virt_orb, dim_list_act_orb, dim_list_virt_orb)
  double precision, intent(out) :: K1d(dim_list_act_orb, dim_list_act_orb, dim_list_virt_orb, dim_list_virt_orb)
...
subroutine space_ccd_J1(t2,J1)
  ...
  do l = 1, nO
    do d = 1, nV
      do k = 1, nO
        do c = 1, nV
          tmp_v(c,k,d,l) = 0.5d0 * v_vvoo(c,d,k,l)
        enddo
      enddo
    enddo
  enddo
  ...
  do l = 1, nO
    do d = 1, nV
      do k = 1, nO
        do c = 1, nV
          tmp_w(c,k,d,l) = 0.5d0 * w_vvoo(c,d,k,l)
        enddo
      enddo
    enddo
  enddo
  ...
  do k = 1, nO
    do a = 1, nV
      do c = 1, nV
        do i = 1, nO
          J1(i,c,a,k) = accu(c,k,i,a) + v_ovvo(i,c,a,k)
        enddo
      enddo
    enddo
  enddo
...
subroutine space_ccd_K1(t2,K1)
  ...
  do l = 1, nO
    do d = 1, nV
      do k = 1, nO
        do c = 1, nV
          tmp_v(c,k,d,l) = 0.5d0 * v_vvoo(d,c,k,l)
        enddo
      enddo
    enddo
  enddo
  ...
  do a = 1, nV
    do k = 1, nO
      do c = 1, nV
        do i = 1, nO
          K1(i,c,k,a) = v_ovov(i,c,k,a) + accu(c,k,i,a)
        enddo
      enddo
    enddo
  enddo
