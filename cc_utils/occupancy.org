...
&BEGIN_PROVIDER [integer, cc_nV_S, (2)]
  ...
  cc_nO_m = max(n_spin(1), n_spin(2))
  cc_nOa  = n_spin(1)
  cc_nOb  = n_spin(2)
  cc_nOab = n_spin(1) + n_spin(2)
  cc_nV_m = max(n_spin(3), n_spin(4))
  cc_nVa  = n_spin(3)
  cc_nVb  = n_spin(4)
...
&BEGIN_PROVIDER [integer, cc_list_vir, (cc_nVa)]
  ...
  call extract_list_orb_space(psi_det(1,1,1),cc_nOa,cc_nVa,cc_list_occ,cc_list_vir)
...
&BEGIN_PROVIDER [integer, cc_list_vir_spin, (cc_nV_m,2)]
  ...
  call extract_list_orb_spin(psi_det(1,1,1),cc_nO_m,cc_nV_m,cc_list_occ_spin,cc_list_vir_spin)
