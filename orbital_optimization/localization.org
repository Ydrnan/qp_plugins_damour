...
subroutine run_localization
  ...
  if (security_mo_class .and. (dim_list_act_orb == mo_num .or. &
    ...
    print*, 'If you want to localize all the orbital:'
  ...
  do l = 1, 4
    ...
    do while (not_converged)
      ...
      do while (cancel_step)
        ...
        call trust_region_step_w_expected_e(tmp_n,tmp_list_size,H,W,e_val,v_grad,prev_criterion,rho,nb_iter,delta,criterion_model,tmp_x,must_exit) 
        if (must_exit) then
          ! ### Message ###
...
Output:
| criterion | double precision | Criterion fr the localization |
