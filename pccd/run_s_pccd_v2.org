...
subroutine run_s_pccd_v2
   ...
   do a = 1, nV
    do i = 1, nO
       ...
       elseif (scc_method == 'guess_mp2') then
         if (dabs(two_e_ints_iiaa(i,a)/(2d0 * f_v(a) - 2d0 * f_o(i))) > max_elem) then
           max_elem = dabs(two_e_ints_iiaa(i,a)/(2d0 * f_v(a) - 2d0 * f_o(i)))
         endif 
       elseif (scc_method == 'estimated_e') then
         if (dabs(two_e_ints_iiaa(i,a)**2/(2d0 * f_v(a) - 2d0 * f_o(i))) > max_elem) then
           max_elem = dabs(two_e_ints_iiaa(i,a)**2/(2d0 * f_v(a) - 2d0 * f_o(i)))
         endif
       else
  ...
  do a = 1, nV
    do i = 1, nO
      ...
      elseif (scc_method == 'guess_mp2') then
        if (dabs(two_e_ints_iiaa(i,a)/(2d0 * f_v(a) - 2d0 * f_o(i))) * normalization_factor >= epsilon_t2) then
          list_key(p,1) = i
          list_key(p,2) = a
          p = p + 1
        else
      ...
      elseif (scc_method == 'estimated_e') then
        if (dabs(two_e_ints_iiaa(i,a)**2/(2d0 * f_v(a) - 2d0 * f_o(i))) * normalization_factor >= epsilon_t2) then
          list_key(p,1) = i
          list_key(p,2) = a
          p = p + 1
        else
