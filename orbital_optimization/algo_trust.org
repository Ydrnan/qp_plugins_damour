...
subroutine algo_trust(tmp_n, tmp_list_size)
  ...
  do while (not_converged)
      ...
      do while (cancel_step)
          ...
          ! Hessian,gradient,Criterion -> x 
          call trust_region_step_w_expected_e(tmp_n,tmp_list_size, H_PROVIDER,W,e_val,g_PROVIDER,prev_criterion,rho,nb_iter,delta,criterion_model,tmp_x,must_exit)
