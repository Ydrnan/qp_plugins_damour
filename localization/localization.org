...
subroutine set_classes_loc()
  ...
  if (security_mo_class) then
    ...
    enddo
    touch dim_list_inact_orb dim_list_virt_orb dim_list_act_orb list_inact list_inact_reverse list_virt list_virt_reverse list_act list_act_reverse
  endif
